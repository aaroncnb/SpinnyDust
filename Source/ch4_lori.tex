\chapter{Analysis of an interesting AME region: $\lambda$~Orionis}
 ...
 \section{An interesting AME region}
  ...
  \subsection{SED Fitting}
    ...
    Fig. \ref{fig:fred_LOri_notes_Oct2017_fig1a}
    ...
    \begin{figure}
      ...
      \centering
      \caption{Example SED of a pixel within $\lambda$~Orionis, along with the dust SED model fit results, and the synthetic photometry points.}
