\chapter{Analysis of an interesting AME region: $\lambda$~Orionis}
 ...
 \section{An intereesting AME region}
  \paragraph{Justification for selection}
   ...
   \paragraph{Where does the ring come from?}
