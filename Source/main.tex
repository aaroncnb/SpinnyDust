...
\subsection{All-sky Pixel Domain Analysis}
  ...
  Finally, we produce an all-sky correlation map. From the NSIDE 256 input maps of each of dust temperature $T$, radiance $R$, and emissivity index beta, and $I 9~\mu$m, we produce NSIDE 16 maps of $S$ for correlation strength vs. AME. These maps are shown in Fig. \ref{fig:Spearman_Map_nside16_AMEtoMBBandA9}.
      ...
      \begin{figure*}
        ...
        \centering
        \caption{ALL-SKY kernel density estimate plots of 12-band infrared photometry results against the PR2 AME map. Pixels within 10$^{\circ}$ of the ecliptic plane are excluded. Darker values indicate higher pixel densities. Plots share logarithmic axes. 'A' indicates AKARI; 'D', DIRBE; 'I', IRAS, and 'P' Planck. The number after each letter indicates the band central nominal wavelength in microns (or frequency in GHz, in the case of the Planck bands.) }
      \end{figure*}
