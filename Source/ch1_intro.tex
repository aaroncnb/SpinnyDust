...
\subsection{Anomalous Microwave Foreground}
  ...
  \subsubsection{Why microwave foregrounds are important}
    ...
    The ISM has intruded into cosmological studies perhaps most prominently with the first claimed detection of B-mode polarization \citep{hanson13, bicep214, flauger14} and the subsequent counter\-claim that this detection arose from galactic dust. More recently, a candidate Sunyaev Zeldovich based galaxy cluster detection, AMI-CL J0300+2613 by \cite{shimwell12} has been suspected to in fact originate from galactic dust and AME \citep{perrott18}.
  ...
  \subsubsection{Proposed explanations}
    ...
    \subsubsection{Spinning dust}
     ...
     \subsubsection{Excitation factors}
       ...
       \subsubsection{AME vs. IR in the literature}
...
\subsection{Scope of this Dissertation}
