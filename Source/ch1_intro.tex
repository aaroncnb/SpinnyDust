...
\subsection{Polycyclic Aromatic Hydrocarbons and the Unidentified Infrared Bands}
    ...
    \paragraph{``PAH'' or ``UIR''?}
     ...
     \subsection{Metrics of Interstellar Dust}
      ...
      Throughout this work we will discuss the ISRF in terms of $U$, which is a conventional measure normalized to the ISRF of the solar neighborhood. In otherwords, a $U$ of 1 indicates...

      In the literature, one may also see references to ``$G$'' or ``$G_0$'', which is essentially giving us the same information as $U$. A $G_0$ of 1 indicates 1 ``Habing unit'', or $1.6\times{}10^{-3} erg s^{-1} cm^{-2}$. This is sometimes indicated in the literature as $G_0$, when discussing the far-UV; they are essentially interchangable.
