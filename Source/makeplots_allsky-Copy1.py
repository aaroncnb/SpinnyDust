...
phot.join(planck_mw['AME']).divide(planck_bb['$R_{PR1}$'], axis=0).head()
...
def displaySpatialCorr(corr_patches_pn,labels, ref_col=0):
    ...
    for j in range(0,len(labels)):
        ...
        plt.savefig("../Plots/Allsky_Corr/Spearman_Map_nside"+str(nside_out)+"_{}to{}.pdf".format(labels[ref_col],labels[j]))
